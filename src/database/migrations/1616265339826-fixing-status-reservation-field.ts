...
export class fixingStatusReservationField1616265339826
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "reservations" DROP COLUMN "fromDate"`,
    );
    await queryRunner.query(`ALTER TABLE "rooms" DROP COLUMN "status"`);
    await queryRunner.query(
      `ALTER TABLE "reservations" ADD "from" integer NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "reservations" ADD CONSTRAINT "UQ_97fe06e36dd45d468d0d08f9d4d" UNIQUE ("from")`,
    );
