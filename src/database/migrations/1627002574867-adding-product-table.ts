...
export class addingProductTable1627002574867 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "products" ("id" SERIAL NOT NULL, "description" character varying(50) NOT NULL, "code" character varying(25) NOT NULL, "price" numeric NOT NULL DEFAULT '0', "altPrice" numeric NOT NULL DEFAULT '0', "stock" numeric NOT NULL DEFAULT '0', "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "created_by" integer NOT NULL, "updated_by" integer NOT NULL, CONSTRAINT "PK_0806c755e0aca124e67c0cf6d7d" PRIMARY KEY ("id"))`);
